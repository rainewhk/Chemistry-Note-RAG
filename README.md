...
- `markdown/`、`images/` 中的化学笔记内容来自 [AnyayayPlus/Chemistry-Note](https://github.com/AnyayayPlus/Chemistry-Note)，内容版权归原作者（AnyayayPlus）所有。本项目仅做格式转换和聚合处理，不改变其版权归属。如有异议，相关内容将被立即移除。
